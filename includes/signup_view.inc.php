...
function check_signup_errors(){
    if (isset($_SESSION["errors_signup"])) {
        ...
        if(isset($errors["username_taken"])){
            echo '<style>#login{border:3px solid red}</style>';
        }

        if(isset($errors["password_dont_match"])){
            echo '<style>#password{border:3px solid red}#repassword{border:3px solid red}</style>';
        }
